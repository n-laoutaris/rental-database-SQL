...
-- TABLE 4: Rentals 
INSERT ALL 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (11,11,TO_DATE('05-MAR-2022', 'DD-MON-YYYY'),TO_DATE('10-MAR-2022', 'DD-MON-YYYY'))
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (1,5, TO_DATE('06-NOV-2024', 'DD-MON-YYYY'), TO_DATE('15-NOV-2024', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (7,10, TO_DATE('10-JAN-2022', 'DD-MON-YYYY'), TO_DATE('10-MAR-2022', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (3,4, TO_DATE('15-MAY-2022', 'DD-MON-YYYY'), TO_DATE('20-AUG-2022', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (19, 14, TO_DATE('01-SEP-2022', 'DD-MON-YYYY'), TO_DATE('30-SEP-2022', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (17,13, TO_DATE('05-NOV-2022', 'DD-MON-YYYY'), TO_DATE('15-NOV-2022', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (1,5, TO_DATE('01-JAN-2023', 'DD-MON-YYYY'), TO_DATE('15-FEB-2023', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (7,9, TO_DATE('10-MAR-2023', 'DD-MON-YYYY'), TO_DATE('10-MAY-2023', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (2,10, TO_DATE('01-JUL-2023', 'DD-MON-YYYY'), TO_DATE('30-JUL-2023', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (5,13, TO_DATE('05-SEP-2023', 'DD-MON-YYYY'), TO_DATE('15-SEP-2023', 'DD-MON-YYYY')) 
  INTO Rentals (apt_id, tnt_id, start_date, end_date) VALUES (3,3, TO_DATE('01-NOV-2023', 'DD-MON-YYYY'), TO_DATE('21-NOV-2023', 'DD-MON-YYYY')) 
